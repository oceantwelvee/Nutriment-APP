...
function calc() {
    ...
    function initalLocalStorage(selector, activeClass) {
        ...
        elements.forEach(elem => {
            ...
            if(elem.getAttribute('ratio') === localStorage.getItem('ratio')) {
                elem.classList.add(activeClass)
            }
        })
    }

    initalLocalStorage('#gender div', 'calculating__choose-item_active');
    initalLocalStorage('.calculating__choose_big div', 'calculating__choose-item_active');
        ...
        render() {
            ...
            element.innerHTML = `
                ...
                <div class="menu__item-price">
                    ...
                    <div class="menu__item-total"><span>${this.price}</span> лари/день</div>
                </div>
            `;
...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_calc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/calc */ "./dist/js/modules/calc.js");
/* harmony import */ var _modules_cards__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/cards */ "./dist/js/modules/cards.js");
/* harmony import */ var _modules_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/forms */ "./dist/js/modules/forms.js");
...
/* harmony import */ var _modules_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/slider */ "./dist/js/modules/slider.js");
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/tabs */ "./dist/js/modules/tabs.js");
